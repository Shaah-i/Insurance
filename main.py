...
from Insurance.components.model_pusher import ModlePusher
...
if __name__== "__main__":
    try:
        ...
        model_pusher= ModlePusher(model_pusher_config= model_pusher_config, data_transformation_artifact= data_transformation_artifact, model_trainer_artifact= model_trainer_artifact)
